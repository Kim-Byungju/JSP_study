...
<script type="text/javascript">
	function deletechk() {
		...
		if(result){
			...
			document.frm.action.value="addressbook_delete";
			document.frm.submit();
		}
	}
...
<body>
	<jsp:useBean id="ab" class="dao.AddressBookDTO" scope="request"/>
	<div align="center">
		<h2>주소록 수정</h2>
		[<a href="AddressController?cmd=addressbook_list">주소록목록으로 이동</a>]
		<form action="AddressController" name="frm" method="post">
			<input type="hidden" name="id" value="<%=ab.getId()%>">
			<input type="hidden" name="cmd" value="addressbook_update">
			<table border="1">
				<tr>
				...
				<tr>
					<td colspan="2" align="center">
						...
						<input type="reset"  value="취소" onclick="location.href='AddressController?cmd=addressbook_list'">&nbsp;
