<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.ArrayList, dao.AddressBookDTO, dao.AddressBookDAO"%>
...
<body>
	<jsp:useBean id="dao" class="dao.AddressBookDAO" scope="page"/>
	<jsp:useBean id="address" class="dao.AddressBookDTO"/>
